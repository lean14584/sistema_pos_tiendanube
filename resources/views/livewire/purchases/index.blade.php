<div class="p-8 max-w-6xl mx-auto">
    <x-page-header title="Compras" subtitle="Todas tus compras a proveedores" icon="shopping-cart">
        <x-slot:actions>
            ...
            <a href="{{ route('purchases.create') }}" wire:navigate class="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-emerald-900/20 hover:bg-emerald-400 active:scale-[0.98] transition-all">
