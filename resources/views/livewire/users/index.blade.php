<div class="p-8 max-w-5xl mx-auto">
    <x-page-header title="Usuarios" subtitle="Usuarios y roles con acceso al sistema" icon="shield-check">
        <x-slot:actions>
            <a href="{{ route('users.create') }}" wire:navigate class="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-emerald-900/20 hover:bg-emerald-400 active:scale-[0.98] transition-all">
