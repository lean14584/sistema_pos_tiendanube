<div class="p-8 max-w-5xl mx-auto">
    <x-page-header title="Categorías" subtitle="Organizá tus productos por categoría" icon="tag">
        <x-slot:actions>
            <a href="{{ route('categories.create') }}" wire:navigate class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-semibold text-indigo-700 shadow-sm hover:bg-white/90 active:scale-[0.98] transition-all">
