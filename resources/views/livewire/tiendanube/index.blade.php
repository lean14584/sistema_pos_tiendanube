<div class="p-8 max-w-3xl mx-auto">
    ...
    <div class="bg-gradient-to-b from-white to-gray-50/60 dark:from-gray-900 dark:to-gray-900/70 rounded-xl border border-gray-200 dark:border-gray-800 shadow-md shadow-gray-200/70 dark:shadow-black/40 p-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Sincronización</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Necesita la conexión guardada.</p>

        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button wire:click="importProducts" wire:loading.attr="disabled" wire:target="importProducts"
                ...
                <span class="text-sm font-medium text-gray-800 dark:text-gray-200">Importar productos</span>
                <span wire:loading wire:target="importProducts" class="text-xs text-gray-400">Importando...</span>
            </button>

            <button wire:click="importOrders" wire:loading.attr="disabled" wire:target="importOrders"
                class="flex flex-col items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-800 p-4 text-center hover:bg-gray-50 dark:hover:bg-gray-800/60 disabled:opacity-60 transition-colors">
                <x-heroicon-o-shopping-cart class="w-6 h-6 text-indigo-500" />
                <span class="text-sm font-medium text-gray-800 dark:text-gray-200">Importar pedidos</span>
                <span wire:loading wire:target="importOrders" class="text-xs text-gray-400">Importando...</span>
            </button>
            ...
            <button wire:click="syncStock" wire:loading.attr="disabled" wire:target="syncStock"
                ...
                <span class="text-sm font-medium text-gray-800 dark:text-gray-200">Sincronizar stock</span>
                <span class="text-[11px] text-gray-400 dark:text-gray-500">sistema → Tiendanube</span>
