...
/*
 * Sin este archivo, Laravel no tiene ningún mensaje de validación para
 * "es" (APP_LOCALE) y muestra la clave cruda sin traducir (ej.
 * "validation.required") en vez de un texto legible — se ve en cualquier
 * formulario ante un error que no tenga un mensaje custom.
 */
...
return [
    ...
    'base64' => 'El campo :attribute debe ser un string Base64 válido.',
    ...
    /*
     * Nombres de campo en español para el placeholder :attribute. Cubre
     * los que se usan en validate() a lo largo del sistema; los que no
     * están acá caen al nombre del campo tal cual (ej. "punto_venta").
     */
    'attributes' => [
        'active' => 'activo',
        'address' => 'dirección',
        ...
        'tipo_comprobante_interno' => 'tipo de comprobante',
