...
class Ean13Barcode
{
     ...
     */
    public static function render(string $code, int $moduleWidth = 4, int $barHeight = 75): string
    {
    ...
    public static function dataUri(string $code, int $moduleWidth = 4, int $barHeight = 75): string
    {
