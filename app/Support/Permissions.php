...
class Permissions
{
    ...
    public const ROLE_PERMISSIONS = [
        'admin' => [
            'dashboard', 'pos', 'quotes', 'invoices', 'clients', 'cobranzas', 'products', 'categories', 'price-lists',
        ...
        'vendedor' => ['dashboard', 'pos', 'quotes', 'invoices', 'clients', 'cobranzas', 'products', 'categories', 'reports', 'messages', 'tasks', 'price-check'],
